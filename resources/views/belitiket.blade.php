...
{{-- RESOURCE ASLI /views/belitiket.blade.php --}}
{{-- @extends('landing.app')
@section('content')
    <div id="pg-tiket" class="pg">
        <div class="th">
                    ...
                    <div class="bst act" id="st1">
                        ...
                        <div class="fg2">
                            ...
                            <select id="rute" class="fc2" onchange="selRoute()">
                                ...
                                <optgroup label="Pulau Sumatera">
                                    <option value="Banda Aceh → Sabang|8 jam|BDA|SBG|Sabang|🌊">Banda Aceh → Sabang</option>
                                    <option value="Sabang → Banda Aceh|8 jam|SBG|BDA|Banda Aceh|🌊">Sabang → Banda Aceh</option>

                                    <option value="Palembang → Muntok|8 jam|PLM|MTK|Muntok|⚓">Palembang → Muntok</option>
                                    <option value="Muntok → Palembang|8 jam|MTK|PLM|Palembang|⚓">Muntok → Palembang</option>
                                    <option value="Pangkal Pinang → Belitung|8 jam|PGK|BLT|Belitung|🏝️">Pangkal Pinang → Belitung </option>
                                    <option value="Belitung → Pangkal Pinang|8 jam|BLT|PGK|Pangkal Pinang|🏝️">Belitung → Pangkal Pinang </option>
                                </optgroup>

                                <optgroup label="Pulau Jawa">
                                    <option value="Gresik → Bawean|8 jam|GRS|BWN|Bawean|🚢">Gresik → Bawean</option>
                                    <option value="Bawean → Gresik|8 jam|BWN|GRS|Gresik|🚢">Bawean → Gresik</option>
                                    <option value="Jepara → Karimunjawa|8 jam|JPR|KRJ|Karimunjawa|🌊">Jepara → Karimunjawa</option>
                                    <option value="Karimunjawa → Jepara|8 jam|KRJ|JPR|Jepara|🌊">Karimunjawa → Jepara</option>
                                    <option value="Kalianget → Kangean|8 jam|KLG|KGN|Kangean|🏝️">Kalianget → Kangean</option>
                                    <option value="Kangean → Kalianget|8 jam|KGN|KLG|Kalianget|🏝️">Kangean → Kalianget</option>
                                </optgroup>

                                <optgroup label="Pulau Timur">
                                    <option value="Kupang → Rote|8 jam|KPG|ROT|Rote|⚓">Kupang → Rote </option>
                                    <option value="Rote → Kupang|8 jam|ROT|KPG|Kupang|⚓">Rote → Kupang </option>
                                    <option value="Banyuwangi → Denpasar|8 jam|BWI|DPS|Denpasar|🚢">Banyuwangi → Denpasar</option>
                                    <option value="Denpasar → Banyuwangi|8 jam|DPS|BWI|Banyuwangi|🚢">Denpasar → Banyuwangi</option>
                                </optgroup>
                            </select>
                        </div>
                        <div class="fr">
...
@endsection --}}
{{-- resources ASLI /views/belitiket.blade.php --}}
...
@section('content')
    !-- PAGE: TIKET -->
    <div id="pg-tiket" class="pg act">
        <div class="th">
            <h1>Pesan Tiket <span>Mudik Gratis</span></h1>
            <p>Lengkapi formulir berikut untuk mendapatkan e-tiket perjalanan Anda</p>
        </div>
        ...
        <div class="bl">
                ...
                <div class="bcard">
                    ...
                    <div class="bst" id="stok">
                        <div class="sv">
                            ...
                            <!-- E-TICKET -->
                            <div id="etw" style="width:100%;max-width:440px">
                                <div class="etw-title">🎫 E-Tiket Mudik Gratis 2025</div>
                                <div class="route-display">
                                    <div class="port">
                                        <div class="port-code" id="tfr">PLM</div>
                                        <div class="port-name">Palembang</div>
                                    </div>
                                    ...
                                    <div class="port">
                                        <div class="port-code" id="tto">MTK</div>
                                        <div class="port-name" id="ttof">Muntok</div>
                                    </div>
                                </div>
                                <div class="et-row"><span class="et-lbl">Tanggal</span><span class="et-val"
                                        id="ttg">—</span></div>
                                ...
                                <div class="et-row"><span class="et-lbl">Biaya</span><span class="et-val">🆓
                                        GRATIS</span></div>
                                <div class="bc-wrap" id="bc"></div>
                                <div class="code-display" id="tcode">BHE-2025-XXXXXX</div>
                            </div>
            ...
            <div class="sidebar">
                <div class="scard">
                    ...
                    <div class="srow">
                        <span class="slb">Rute</span>
                        <span class="svl" id="srt" style="color:var(--g4)">Pilih rute...</span>
                    </div>
                    <div class="srow">
                        <span class="slb">Tanggal</span>
                        <span class="svl" id="stg">—</span>
                    </div>
                    <div class="srow">
                        <span class="slb">Kelas</span>
                        <span class="svl" id="skl">Ekonomi</span>
                    </div>
                    <div class="srow">
                        <span class="slb">Penumpang</span>
                        <span class="svl" id="ssd">1 penumpang</span>
                    </div>
                    <div class="sfree" style="margin-top:16px">
                        <div class="sfree-lbl">TOTAL BIAYA</div>
                        <div class="sfree-val">GRATIS</div>
                    </div>
                </div>
...
<div id="pg-tiket" class="pg">
    ...
    <div class="bl">
        <div>
            ...
            <div class="bsb">
                <div class="bs2 act" id="ind1" onclick="showStep('st1','ind1')"><span class="bsn">1</span> Pilih Rute</div>
                <div class="bs2"     id="ind2" onclick="showStep('st2','ind2')"><span class="bsn">2</span> Data Penumpang</div>
                <div class="bs2"     id="ind3" onclick="showStep('st3','ind3')"><span class="bsn">3</span> Konfirmasi</div>
            </div>
            ...
            <div class="bcard">
                ...
                <div class="bst act" id="st1">
                    ...
                    <div class="fr">
                        <div class="fg2">
                            <label>Tanggal Keberangkatan <span class="req">*</span></label>
                            <input type="date" id="tgl" class="fc2" min="2025-03-26" max="2025-04-04" value="2025-03-26" onchange="upSum()">
                        </div>
                        <div class="fg2">
                            <label>Kelas Tiket</label>
                            <select id="kls" class="fc2" onchange="upSum()">
                    ...
                    <div class="nb2">
                        <button class="bln" onclick="showStep('st2','ind2')">Lanjut: Data Penumpang →</button>
                    </div>
                </div>
                ...
                <div class="bst" id="st2">
                    ...
                    <div id="pxf"></div>
                    <div class="nb2">
                        <button class="bbk" onclick="showStep('st1','ind1')">← Kembali</button>
                        <button class="bln" onclick="showStep('st3','ind3')">Konfirmasi →</button>
                    </div>
                </div>
                ...
                <div class="bst" id="st3">
                    ...
                    <div id="kdet"></div>
                    <div class="nb2">
                        <button class="bbk" onclick="showStep('st2','ind2')">← Kembali</button>
                        <button class="bps" onclick="pesan()">🎫 Dapatkan E-Tiket Gratis</button>
                    </div>
                </div>
                ...
                <div class="bst" id="stok">
                    <div class="sv">
                        <div class="sch">✓</div>
                        <h2>Tiket Berhasil Dipesan!</h2>
                        <p>E-tiket Anda telah berhasil dibuat. Tunjukkan tiket kepada petugas saat boarding di pelabuhan.</p>
                        <button class="bpri" onclick="sp('home')">← Kembali ke Beranda</button>
                    </div>
                </div>
...
<script>
function showStep(stepId, indId) {
    document.querySelectorAll('.bst').forEach(s => s.classList.remove('act'));
    document.querySelectorAll('.bs2').forEach(b => b.classList.remove('act'));
    document.getElementById(stepId).classList.add('act');
    document.getElementById(indId).classList.add('act');
}
</script>
